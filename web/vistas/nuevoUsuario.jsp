    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input id="nombre" type="text" class="form-control" placeholder="Ejem: Oliver" name="txtNombre" maxlength="10"
                                               value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input id="nombre" type="password" class="form-control" placeholder="Ejem: $%Oli!**" name="txtClave" maxlength="10"
                                               value="">
                                    </div>
                                </div>
                                <div class="form-group">
            ...
            <footer class="main-footer">
                ...
                <!-- Default to the left -->
                <strong>Copyright &copy; 2024 <a href="#">SS</a>.</strong> Todos los derechos reservados.
            </footer>
